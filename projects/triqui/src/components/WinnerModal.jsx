...
const WinnerModal = ({ winner, resetGame }) => {
    ...
    return(
        ...
        <div className='bg-[#5C469C] h-[330px] w-[330px] border-2 border-white rounded-[10px] flex flex-col justify-center items-center gap-10 md:h-[450px] md:w-[450px] lg:h-[330px] lg:w-[330px]'>
            <h2 className='text-2xl lg:text-xl md:text-3xl'>{winnerText}</h2>
